...
class AllSetLoader(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        lf_crop = rearrange(lf_crop, '(u v) h w -> (u h) (v w)', u = self.angRes, v = self.angRes)
        
        lf_crop = ToTensor()(lf_crop.copy())
        disp_crop = ToTensor()(disp_crop.copy())
        lf_crop = rearrange(lf_crop, 'c (u h) (v w) -> c u v h w', u = self.angRes, v = self.angRes)
